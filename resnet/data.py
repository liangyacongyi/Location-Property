...
------------      -------    --------    -----------
2019/1/1 11:28 AM   liangcong      1.0   download cifar-10/100 data and read them
"""
import pickle
import numpy as np
import os
...
def get_data_set(name="train", cifar=10, aug=False):
    ...
    if cifar == 10:
        ...
        f = open('/home/newnfs/jackylc/data/data_set/' + folder_name + '/batches.meta', 'rb')
        label_str = "label_names"
    else:
        folder_name = "cifar_100"
        f = open('/home/newnfs/jackylc/data/data_set/' + folder_name + '/meta', 'rb')
    ...
    if name is "train":
        if cifar == 10:
            for i in range(5):
                f = open('/home/newnfs/jackylc/data/data_set/' + folder_name + '/data_batch_' + str(i + 1), 'rb')
                datadict = pickle.load(f)
                f.close()
                _X = datadict["data"]
                _Y = datadict['labels']
            ...
            f = open('/home/newnfs/jackylc/data/data_set/' + folder_name + '/train', 'rb')
        ...
        if cifar == 10:
            f = open('/home/newnfs/jackylc/data/data_set/' + folder_name + '/test_batch', 'rb')
            label_str = "labels"
        else:
            f = open('/home/newnfs/jackylc/data/data_set/' + folder_name + '/test', 'rb')
...
def maybe_download_and_extract(cifar):
    ...
    :return: none
    """
    main_directory = "/home/newnfs/jackylc/data/data_set/"
